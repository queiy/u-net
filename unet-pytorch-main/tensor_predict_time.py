...
def trt_overlap_inference(input_dir, output_dir):
    ...
    for img_path in image_files:
        ...
        print(f"\n🖼️ Processing {img_path.name} ({orig_w}x{orig_h})")
        ...
        cv2.imwrite(str(output_file), (pred_mask * 255).astype(np.uint8))
    ...
    if total_imgs > 0:
        ...
        print(f"🧮 平均时间: {total_time / total_imgs:.4f} 秒")
        print(f"🚀 FPS: {total_imgs / total_time:.2f}")
        print("=================================================")
